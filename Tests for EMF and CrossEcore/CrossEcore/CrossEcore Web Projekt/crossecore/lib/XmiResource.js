 ...
 */
define(["require", "exports", "./EcorePackageImpl", "./EcoreFactoryImpl", "./EReferenceImpl", "./EClassImpl", "./ENamedElementImpl", "./EAttributeImpl", "./EDataTypeImpl"], function (require, exports, EcorePackageImpl_1, EcoreFactoryImpl_1, EReferenceImpl_1, EClassImpl_1, ENamedElementImpl_1, EAttributeImpl_1, EDataTypeImpl_1) {
    "use strict";
        ...
        function XmiResource(epackage, efactory, domParser) {
            ...
            this.resolveEObject = function (specification) {
                if (specification === null) {
                    ...
                    var name_2 = specification.substring(index + 40, specification.length);
                    ...
                    return _this.resolveRecurr(queue, EcorePackageImpl_1.EcorePackageImpl.eINSTANCE);
                }
            };
            ...
            this.addEStructuralFeatures = function (eobject, node) {
                for (var i = 0; i < node.attributes.length; i++) {
                    ...
                    var name_3 = attribute.name;
                    var estructuralfeature = eobject.eClass().getEStructuralFeature(name_3);
