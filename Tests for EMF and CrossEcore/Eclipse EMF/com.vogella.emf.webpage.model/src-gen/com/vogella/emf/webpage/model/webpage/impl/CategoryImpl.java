 ...
 *   <li>{@link com.vogella.emf.webpage.model.webpage.impl.CategoryImpl#getArticles <em>Articles</em>}</li>
 *   <li>{@link com.vogella.emf.webpage.model.webpage.impl.CategoryImpl#getNumber <em>Number</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CategoryImpl extends MinimalEObjectImpl.Container implements Category {
	...
	public void setNumber(short newNumber) {
		...
		number = newNumber;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebpagePackage.CATEGORY__NUMBER, oldNumber, number));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case WebpagePackage.CATEGORY__ARTICLES:
			return getArticles();
		case WebpagePackage.CATEGORY__NUMBER:
			return getNumber();
		}
